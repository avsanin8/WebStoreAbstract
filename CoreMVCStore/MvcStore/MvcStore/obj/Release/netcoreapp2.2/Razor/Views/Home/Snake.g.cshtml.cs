#pragma checksum "I:\_GitHub\WebStoreAbstract\CoreMVCStore\MvcStore\MvcStore\Views\Home\Snake.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cf3322b60ee7a9d717ca48f9df4b33f77dd29d30"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cf3322b60ee7a9d717ca48f9df4b33f77dd29d30", @"/Views/Home/Snake.cshtml")]
...
<style>
    ...
    <h6>An example of an interesting game ""Snake"" on pure JavaScript (without frameworks and libraries). Was used tutorial by Хауди Хо™ - Просто о мире IT! (<a href=""https://youtu.be/YNZjcDk98rs"">Link</a>)</h6>
    ...
    <script>
        ...
        window.onload = function(){
            document.addEventListener('keydown', changeDirecti");
            WriteLiteral(@"on);
        }
        ...
        py             ");
            WriteLiteral(@"     = ~~(canv.height) / 2, // player Y position
        ...
        function loop()
        {
           ...
           ");
            WriteLiteral(@"         apples.splice(a, 1); // remove this apple from the apples list
                    score++; // set score
        ...
        function spawnApple()
        {
            ...
            // check for col");
            WriteLiteral(@"lisions with tail element, so no apple will be spawned in it
        ...
        function rc() {
            ...
            for (var i = 0; i < 6; i++) {
                col += lett");
            WriteLiteral(@"ers[Math.floor(Math.random() * 16)];
            }
            return col;
        }
        ...
        function changeDirection(evt)
        {
            ...
            */
            ...
            cooldown = true;
 ");
            WriteLiteral("           setTimeout(function()  {cooldown = false;}, 100);\r\n        }\r\n\r\n    </script>\r\n");
            EndContext();
